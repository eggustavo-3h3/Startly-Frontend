...
export class startupService{
    ...
    listarStartups() : Observable<Startup[]> {
        ...
        return this.http.get<Startup[]>(`${this.baseUrl}/startup/listar`, { headers: this.authService.getAutheHeaders() })
    }
    ...
    atualizarStartup(startup: Startup) : Observable<Startup[]> 
    {
        ...
        return this.http.put<Startup[]>(`${this.baseUrl}/startup/atualizar`, startup, { headers: this.authService.getAutheHeaders() })
    }

    removerStartup(id: string) : Observable<Startup[]> {
        // Método para remover uma startup
        return this.http.delete<Startup[]>(`${this.baseUrl}/startup/remover/${id}`, { headers: this.authService.getAutheHeaders() })
    }    
}